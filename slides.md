...
info: |
  ...
  Starting with concrete examples: See working polyglot systems first, understand why second.
  Python orchestrating Rust, C++, Zig, JavaScript for real-world performance needs.
...
- Jump straight into working examples
- Show before tell - concrete before abstract
- Each example demonstrates a real performance problem solved
- Theory comes after they've seen it work
-->
...
Let me show you something that works.
...
<!--
Opening hook: Skip the theory. Start with working code.
We're doing top-down: concrete examples first, patterns second.
-->
...
<div v-click class="mt-8 grid grid-cols-4 gap-8">
...
All pip-installable. All solving real problems.
...
Four real systems. All pip-installable. All solving actual problems.

</div>

<div v-click class="mt-4">

Now let's talk about **why** and **how** they work.
...
# Part II: The Patterns Behind It

Understanding what you just saw

<!--
SPEAKER NOTES - ARCHITECTURE:
- Now that they've seen it work, explain the theory
